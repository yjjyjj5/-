...
namespace 俄罗斯方块
{
    ...
    {
        Bitmap bitmap = new Bitmap(250, 375);
        Bitmap bitmap2;
        Graphics g;
        Graphics gMain;
        Graphics gDouble;
        ...
        public FrmMain()
        {
            ...
            gMain = this.pGame.CreateGraphics();
            bitmap2 = new Bitmap(this.pGame.Width, this.pGame.Height);
            gDouble = Graphics.FromImage(bitmap2);
        ...
        {
            PointF pointf = new PointF(250F, 207.5F);
            Matrix matrix = gMain.Transform;
            matrix.RotateAt(1, pointf);
            gMain.Transform = matrix;
            画游戏();
        }
        ...
        private void 画游戏()
        {
            ...
            gDouble.DrawImage(bitmap, 125, 40);
            gMain.DrawImage(bitmap2, 0, 0);
        }
        ...
        public void 产生下一个方块()
        {
            ...
            else if (num == 1) fkNext = new 田字形();
            else if (num == 2) fkNext = new 二字形();
            else if (num == 3) fkNext = new 反二形();
            else if (num == 4) fkNext = new 七字形();
            else if (num == 5) fkNext = new 反七形();
            else fkNext = new 一字形();
        }
